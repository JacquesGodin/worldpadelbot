...
def draftlist_verifier(player): #função que verifica se o jogador já se inscreveu e o adiciona à lista caso ainda não o tenha feito. Só pode estar aberto entre segunda e quarta-feira
  with open('list.txt',"r+") as draftlist:
...
if 2 <= dayofweek <= 3 and datetime.now().hour < 20: #aqui especificamos que a inscrição só pode ser feita até quarta-feira (dia 2 da semana)
